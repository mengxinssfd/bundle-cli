...
new (function (_) {
  ...
  var Package = Base.extend({
    ...
    toString: function () {
      return format(
        '[%1]',
        this.parent ? String(this.parent).slice(1, -1) + '.' + this.name : this.name,
      );
    },
  });
  ...
  var Map = Base.extend({
    ...
    has: function (a) {
      /*@cc_on@*/ /*@if(@_jscript_version<5.5)return $Legacy.has(this,_14+a);@else@*/ return (
        _14 + a in this
      ); /*@end@*/
    },
    merge: function (b) {
  ...
  function _24(a, b, c) {
    ...
    if (typeof a == 'string') {
      ...
      for (i = 0; i < d; i++) {
        /*@cc_on@*/ /*@if(@_jscript_version<5.2)if(a[i]!==undefined||$Legacy.has(a,i))@else@*/ if (
          i in a
        )
          /*@end@*/ b.call(c, a[i], i, a);
      }
    }
  }
  function _8(g, h, j, k) {
  ...
  function instanceOf(a, b) {
    ...
    /*@cc_on@*/ /*@if(@_jscript_version<5.1)if($Legacy.instanceOf(a,b))return true;@else@*/ if (
      a instanceof b
    )
      return true;
...
new (function (_) {
  ...
  var Interface = Module.extend(null, {
    ...
    createDelegate: function (a, b) {
      if (!this[a]) {
        var c =
          "var fn=function _%1(%2){%3.base=%3.%1.ancestor;var m=%3.base?'base':'%1';return %3[m](%4)}";
  ...
  var CSSParser = RegGrp.extend(
    ...
    },
    {
      ...
      _47: function (c, d, e, f, g, h, i, j) {
        ...
        var l = format(
          a == 0 ? '%3%7' + (f + b) : '(%4%3-%2)%6%1%70%5%4%3>=%2',
          a,
          b,
          e,
          f,
  ...
  var XPathParser = CSSParser.extend(
    {
      ...
      '@opera': {
        unescape: function (a) {
          return this.base(
            a.replace(/last\(\)/g, 'count(preceding-sibling::*)+count(following-sibling::*)+1'),
          );
        },
      },
    },
  ...
  new (function (_) {
    ...
    var _53 = {
      ...
      'only-child':
        '!Traversal.getPreviousElementSibling(e%1)&&!Traversal.getNextElementSibling(e%1)',
    ...
    var _60 =
      'fn=function(e0,s){indexed++;var r=[],p={},reg=[%1],' +
...
base2.code.Colorizer.javascript.add(
  '\\b(' +
    (base2.exports + ',base,base2,merge,union,implement,Array2,Date2,String2')
      .match(/[^\s,]+/g)
      .join('|') +
    ')\\b',
...
var Packer = Base.extend(
  {
    ...
    _shrinkVariables: function (script) {
      ...
      var encode52 = function (c) {
        return (
          (c < 52 ? '' : arguments.callee(parseInt(c / 52))) +
